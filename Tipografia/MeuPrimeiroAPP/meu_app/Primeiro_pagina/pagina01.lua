...
local teste2 = nil
local Texto = {
    Fonte = native.newFont("/meu_app/Melon.ttf", 30)
}
...
function cena:create( evento )
    ...
    -------------------------------------------------------------------------------
        -----                   Logo da Página                                            ---
        -------------------------------------------------------------------------------
        Texto.LogoTipo1 = "ETEC"

    Texto.LogoTipo = display.newText(
        Texto.LogoTipo1,
        config.LarguraDaTela * 0.5,
        config.AlturaDaTela * 0.2,
        Texto.Fonte,
        config.LarguraDaTela * .2
        
    )
    Texto.LogoTipo:setFillColor(0, 5, 0.1)
end
...
function cena:show( evento )
    ...
    if ( fazer == "will" ) then
        ...
        -- 
        transition.to(Texto.LogoTipo, { 
            x =  Texto.LogoTipo.height * .97, 
            time = 500}
        )
